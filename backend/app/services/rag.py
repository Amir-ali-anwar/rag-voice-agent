...
class RAGService:
    ...
    async def retrive(self, query:str,k:int = 5, equipment_id:str | None=None,tenant_id:str | None=None, extra_filters:dict | None=None, include_content:bool =True ) -> RetrievalResult:
        db = get_database()
        ...
        try:
            ...
            if filters:
                ...
                logger.debug(f"Added vector search filter: {filters}")
            ...
            try:
                ...
                logger.success(f"Successfully processed {len(chunks)} chunks")
            except Exception as e:
